...
! function (e) {
    ...
    var a, r, l = document.createElement("div"),
        s = t("transform"),
        c = t("perspective"),
    ...
    y.prototype.css = function (t, n) {
        ...
        for (var o = 0, a = t.$item; null !== a && a !== document && 0 === o;) {
            ...
            r && "none" !== r && (o = 1, t.css(t.image.$container, {
    ...
    var v = function (e) {
        ...
        var t, n = arguments[1],
            ...
            a = 0;
        for (a; a < o; a++)
            if ("object" == typeof n || "undefined" == typeof n ? e[a].jarallax || (e[a].jarallax = new y(e[a], n)) : e[a].jarallax && (t = e[a].jarallax[n].apply(e[a].jarallax, i)), "undefined" != typeof t) return t;
        return e
    };
    v.constructor = y;
    var x = e.jarallax;
